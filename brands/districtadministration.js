...
export const districtadministration = createBrand({
  id: "districtadministration",
  name: "District Administration",
  stealthLink: "https://districtadministration.com/stealth-click?utm_source=bot-test&utm_medium=email&utm_campaign=stealth",
  divider: {
      ...
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:100%;max-width:600px;margin:0 auto;">
        ...
        <tr>
          <td align="center" style="padding:16px 20px 14px 20px;">
            <a href="https://districtadministration.com/" target="_blank" style="text-decoration:none;">
              <img
                src="https://cdn.omeda.com/hosted/images/CLIENT_LRP/LRPCD/District_Administration_Logo_full_color.png"
      ...
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:100%;max-width:600px;margin:0 auto;">
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto;">
              <tr>
                <td style="padding:0 5px;">
                  <a href="https://www.linkedin.com/company/district-administration" target="_blank" style="text-decoration:none;">
                ...
                <td style="padding:0 5px;">
                  <a href="https://twitter.com/DA_magazine" target="_blank" style="text-decoration:none;">
                ...
                <td style="padding:0 5px;">
                  <a href="https://www.facebook.com/DistrictAdministration/" target="_blank" style="text-decoration:none;">
        ...
        <tr>
          <td style="padding:0 24px 24px 24px;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;font-size:12px;line-height:1.5;color:#777777;text-align:center;">
            <p style="margin:0 0 6px 0;">Entire contents copyright &copy; @{mv_date_yyyy}@ <i>District Administration</i>. All rights reserved.</p>
